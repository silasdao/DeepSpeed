    ...
    if "DS_ACCELERATOR" in os.environ:
        ...
        if accelerator_name == "xpu":
            try:
                ...
                raise ValueError(
                    "XPU_Accelerator requires intel_extension_for_deepspeed, which is not installed on this system."
                )
            ...
            try:
                ...
                raise ValueError(
                    "CPU_Accelerator requires intel_extension_for_pytorch, which is not installed on this system."
                )
            ...
            try:
                ...
                raise ValueError(
                    "NPU_Accelerator requires torch_npu, which is not installed on this system."
                )
            ...
            try:
                ...
                raise ValueError(
                    "MPS_Accelerator requires torch.mps, which is not installed on this system."
                )
